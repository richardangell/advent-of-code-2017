...
def count_memory_cycles(file, verbose = False):
    ...
    print(redistribution_cycles - i)

    return(redistribution_cycles - i)
...
if __name__ == '__main__':
    ...
    if len(sys.argv[1:]) > 1:
        ...
        count_memory_cycles(sys.argv[1], sys.argv[2])

    else:

        count_memory_cycles(sys.argv[1])
